...
def parse_args():
    ...
    parser.add_argument("--run_name", type=str, default="hq", help="run model name")
    ...
    parser.add_argument("--resume", type=str, default="pretrain_model/sam-med2d_b.pth", help="load resume") 
    ...
    parser.add_argument("--mode", type=str, default='train', help="test or train mode")
    ...
    parser.add_argument("--experts", type=int, default=8, help="amount of experts")
    parser.add_argument("--rank", type=int, default=24, help="rank")
...
def main(args):
    ...
    frozen_layer_moe(model)
    train_dataset = TrainingDataset(args.data_path, image_size=args.image_size, mode='train', point_num=1, mask_num=args.mask_num, requires_name = False, label=0)
